...
def train(n_epochs, model, optimizer, criterion, use_cuda, save_path):
    f = open("age_Denesnet121_train_loss.txt", "a")
    fv = open("age_Denesnet121_val_loss.txt", "a")
    fta = open("age_Denesnet121_train_acc.txt", "a")
    fva = open("age_Denesnet121_val_acc.txt", "a")
...
train(25, model, optimizer, criterion, use_cuda, 'ageDenesnet121.pt')
# %%;p;
model.load_state_dict(torch.load('ageDenesnet121.pt'))
# %%
test(model, criterion, use_cuda)
