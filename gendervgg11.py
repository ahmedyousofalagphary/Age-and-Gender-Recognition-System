...
def train(n_epochs, model, optimizer, criterion, use_cuda, save_path):
    f = open("gender_alexnet_train_loss.txt", "a")
    fv = open("gender_alexnet_val_loss.txt", "a")
    fta = open("gender_alexnet_train_acc.txt", "a")
    fva = open("gender_alexnet_val_acc.txt", "a")
...
train(25, model, optimizer, criterion, use_cuda, 'gendervgg11.pt')
# %%;p;
model.load_state_dict(torch.load('gendervgg11.pt'))
# %%
test(model, criterion, use_cuda)
