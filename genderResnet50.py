...
print(os.listdir("gender dataset"))
...
def train(n_epochs, model, optimizer, criterion, use_cuda, save_path):
    f = open("genderresnet50_train_loss.txt", "a")
    fv = open("genderresnet50_val_loss.txt", "a")
    fta = open("genderresnet50_train_acc.txt", "a")
    fva = open("genderresnet50_val_acc.txt", "a")
...
train(20, model, optimizer, criterion, use_cuda, 'genderresnet50.pt')
# %%;p;
model.load_state_dict(torch.load('genderresnet50.pt'))
# %%
test(model, criterion, use_cuda)
