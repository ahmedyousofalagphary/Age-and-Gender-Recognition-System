...
def train(n_epochs, model, optimizer, criterion, use_cuda, save_path):
    f = open("age_resnet_train_loss.txt", "a")
    fv = open("age_resnet_val_loss.txt", "a")
    fta = open("age_resnet_train_acc.txt", "a")
    fva = open("age_resnet_val_acc.txt", "a")
...
train(25, model, optimizer, criterion, use_cuda, 'ageResNet18.pt')
# %%;p;
model.load_state_dict(torch.load('ageresnet18.pt'))
# %%
test(model, criterion, use_cuda)
