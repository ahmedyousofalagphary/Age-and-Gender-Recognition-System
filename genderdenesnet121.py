...
print(os.listdir("genderdatasetnew"))
...
def train(n_epochs, model, optimizer, criterion, use_cuda, save_path):
    f = open("gender_Denesnet121_train_loss.txt", "a")
    fv = open("gender_Denesnet121_val_loss.txt", "a")
    fta = open("gender_Denesnet121_train_acc.txt", "a")
    fva = open("gender_Denesnet121_val_acc.txt", "a")
...
train(25, model, optimizer, criterion, use_cuda, 'genderDenesnet121.pt')
# %%;p;
model.load_state_dict(torch.load('genderDenesnet121.pt'))
# %%
test(model, criterion, use_cuda)
